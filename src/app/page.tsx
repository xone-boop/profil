  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      {/* ============================================
          Hero Section
          ============================================ */}
      <section className="relative pt-0 pb-12 md:pt-0">
      ...
      {/* ============================================
          ...
          ============================================ */}
      <section className="py-8 bg-foreground relative overflow-hidden">
        {/* Background Pattern */}
      ...
      {/* ============================================
          Final CTA Section
          ============================================ */}
      <section className="py-8 px-4 bg-gradient-to-br from-primary to-primary-light text-white border-t-4 border-foreground relative overflow-hidden">
